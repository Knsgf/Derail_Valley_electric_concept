...
4. Drag and drop both [Catenary-DC.zip](https://github.com/Knsgf/Derail_Valley_electric_concept/releases/download/v2.2.2/Catenary-DC.zip) and [2WE3CCL.zip](https://github.com/Knsgf/Derail_Valley_electric_concept/releases/download/v2.2.2/2WE3CCL.zip) into UMM.
 The first file contains simulation code and catenary, the second is locomotive model itself. Both are required.
5. It's strongly recommended to read the [operating manual](https://github.com/Knsgf/Derail_Valley_electric_concept/releases/download/v2.2.2/2WE3_manual.pdf). The control scheme and operation of the locomotive are different from vanilla diesel and battery electric.
